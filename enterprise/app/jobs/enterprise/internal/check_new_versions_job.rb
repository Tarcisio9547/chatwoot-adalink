module Enterprise::Internal::CheckNewVersionsJob
  ...
  def update_plan_info
    ...
    # Self-hosted enterprise: nunca sobrescrever o plano a partir do hub.
    # O pricing_plan é controlado exclusivamente via chatwoot_hub.rb hardcoded.
    # Apenas atualizar campos de suporte (não afetam licença).
